...
var UserInfo = /** @class */ (function () {
    ...
    UserInfo.prototype.getAddress = function () {
        return "".concat(this.user.address.zipcode, ", ").concat(this.user.address.city, ", ").concat(this.user.address.street, ", ").concat(this.user.address.suite);
    };
    UserInfo.prototype.getCompany = function () {
        return "".concat(this.user.company.name);
    };
    UserInfo.prototype.getUserName = function () {
        return "".concat(this.user.username);
    };
    return UserInfo;
}());
function logUsers() {
